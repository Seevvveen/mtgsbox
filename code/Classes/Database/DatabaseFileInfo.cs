...
static class DatabaseFileInfo
{
	...
	public static readonly JsonSerializerOptions DatabaseJsonOptions = new JsonSerializerOptions { WriteIndented = false, Converters = { new JsonStringEnumConverter( null, false ) } };
	...
	public static readonly JsonSerializerOptions LegacyDatabaseJsonOptions = new JsonSerializerOptions { WriteIndented = false };
}
