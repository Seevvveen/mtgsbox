...
{
	private readonly Dictionary<string, string>? _purchaseUris;
	private readonly Dictionary<string, string>  _relatedUris = new Dictionary<string, string>( StringComparer.OrdinalIgnoreCase );
	...
	{
		get { return _purchaseUris; }
		init { _purchaseUris = value is null? null : new Dictionary<string, string>( value, StringComparer.OrdinalIgnoreCase ); }
	}

	public Dictionary<string, string> RelatedUris
	{
		get { return _relatedUris; }
		init { _relatedUris = value is null? new Dictionary<string, string>( StringComparer.OrdinalIgnoreCase ) : new Dictionary<string, string>( value, StringComparer.OrdinalIgnoreCase ); }
	}
}
