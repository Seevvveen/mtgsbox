...
public sealed class ScryfallSymbologyDto
{
	...
	[JsonPropertyName( "data" )] public ScryfallCardSymbolDto[] Data { get; set; } = [ ];
...
public sealed class ScryfallCardSymbolDto
{
	...
	[JsonPropertyName( "loose_variant" )] public string? LooseVariant { get; set; }
	...
	[JsonPropertyName( "funny" )] public bool Funny { get; set; }
	...
	[JsonPropertyName( "gatherer_alternates" )] public string[]? GathererAlternates { get; set; }
