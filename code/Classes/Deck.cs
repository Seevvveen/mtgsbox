...
public static class DeckJson
{
	...
	public static Deck Deserialize( string json )
	{
		...
		Deck deck = JsonSerializer.Deserialize<Deck>( json, Options )
			?? throw new JsonException( "Deck JSON deserialized to null." );

		if ( deck.SchemaVersion != Deck.CurrentSchemaVersion )
		{
			throw new NotSupportedException(
				$"Deck schema version {deck.SchemaVersion} is not supported." );
		}
