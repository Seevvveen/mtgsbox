...
[AssetType(
	...
	Extension = "mtggame",
	Category = "Card Games" )]
public sealed class MtgGameDefinition : GameResource
{
	[Property]
	public string DisplayName { get; set; } = "Magic";
	...
	[Property]
	public PrefabFile? RulesPrefab { get; set; }

	[Property]
	public int MinimumPlayers { get; set; } = 2;

	[Property]
	public int MaximumPlayers { get; set; } = 2;
	...
	[Property]
	public float CardWidth { get; set; } = CardMesh.DefaultWidth;

	[Property]
	public float CardThicknessRatio { get; set; } =
		CardMesh.DefaultThicknessRatio;

	public override void ConfigurePublishing(
		ResourcePublishContext context )
	{
		if ( RulesPrefab is null )
			context.SetPublishingDisabled(
				"Invalid: missing an MTG rules prefab." );
